function [bins, counts, edges] = parhistweight_2d(dCoords, dValues, dLimits, dGranularity, i32Algorithm, ui8Numthreads, dGaussianSigma, dWindowSize)%#codegen
...
parfor idx = 1:ui8NumOfPools
    [bins_pools{idx}, counts_pools{idx}] = histweight_2d(coords_pools{idx}, values_pools{idx}, dLimits, dGranularity, i32Algorithm, ...
